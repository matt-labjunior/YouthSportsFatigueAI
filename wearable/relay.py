...
class Handler(BaseHTTPRequestHandler):
 ...
 def identity(self):
  if not TOKEN or not hmac.compare_digest(self.headers.get('Authorization',''),'Bearer '+TOKEN):self.respond(401,{'error':'Unauthorized'});return None
...
def main():
 ...
 print('Demo relay listening. Use trusted HTTPS for iPhone access. Records are simulated and held in memory.')
